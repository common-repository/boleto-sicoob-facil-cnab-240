...
include_once('BoletoSicoobFacilCnab_InstallIndicator.php');

class BoletoSicoobFacilCnab_LifeCycle extends BoletoSicoobFacilCnab_InstallIndicator {
    ...
    public function uninstall() {
        $this->otherUninstall();
        $this->uninstallDatabaseTablesCFF();
